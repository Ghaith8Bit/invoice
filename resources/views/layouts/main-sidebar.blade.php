				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">List of paid invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">List of unpaid invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">List of partially paid invoices</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">Reports of invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">Reports of customers </a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='alerts') }}">List of Users</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='avatar') }}">Users Permissions</a></li>
						</ul>
					</li>
					<li class="side-item side-item-category">Advanced</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='background') }}">Add section</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='border') }}">Add product</a></li>
